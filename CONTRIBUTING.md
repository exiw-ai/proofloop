...
1. Check if the issue already exists in [GitHub Issues](https://github.com/egorx1/proofloop/issues)
...
Open a [discussion](https://github.com/egorx1/proofloop/discussions) for questions or ideas.
