...
1. Check if the issue already exists in [GitHub Issues](https://github.com/exiw-ai/proofloop/issues)
...
Open a [discussion](https://github.com/exiw-ai/proofloop/discussions) for questions or ideas.
