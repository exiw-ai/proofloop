...
class TestJsonTaskRepoConditions:
    async def test_save_conditions_approval(
        ...
        # Verify file exists
        conditions_path = repo._task_dir(sample_task.id) / "approvals" / "conditions.json"
...
class TestJsonTaskRepoPlan:
    async def test_save_plan_approval(
        ...
        plan_path = repo._task_dir(sample_task.id) / "approvals" / "plan.json"
...
class TestJsonTaskRepoInventory:
    async def test_save_inventory(
        ...
        inventory_path = repo._task_dir(sample_task.id) / "inventory" / "inventory.json"
