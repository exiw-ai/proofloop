...
class TestIsDuplicate:
    ...
    def test_duplicate_by_doi(self, deduplicator: SourceDeduplicator, source_factory) -> None:
        source1 = source_factory(locator={"doi": "10.1234/test"})
        is_dup, existing = deduplicator.is_duplicate(
            "https://different.com",
            {"doi": "10.1234/test"},
            [source1],
    ...
    def test_duplicate_by_arxiv_id(self, deduplicator: SourceDeduplicator, source_factory) -> None:
        source1 = source_factory(locator={"arxiv_id": "2301.12345"})
        is_dup, existing = deduplicator.is_duplicate(
            "https://different.com",
            {"arxiv_id": "2301.12345"},
            [source1],
    ...
    def test_duplicate_by_github_sha(
        ...
        source1 = source_factory(locator={"github_sha": "abc123def456"})
        is_dup, existing = deduplicator.is_duplicate(
            "https://different.com",
...
class TestFindDuplicates:
    ...
    def test_finds_duplicates_by_locator(
        ...
        sources = [
            source_factory(canonical_url="https://a.com", locator={"doi": "10.1234/test"}),
            source_factory(canonical_url="https://b.com", locator={"doi": "10.1234/test"}),
        ]
        duplicates = deduplicator.find_duplicates(sources)
        assert len(duplicates) == 1
