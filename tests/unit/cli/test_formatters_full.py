...
class TestFormatToolResult:
    ...
    def test_formats_bash_success_result(self):
        """format_tool_result should show Bash result line count."""
        console = make_console()
        msg = AgentMessage(
            role="tool_result",
    ...
    def test_formats_multiline_result(self):
        """format_tool_result should show multiline Bash results count."""
        console = make_console()
        msg = AgentMessage(
            role="tool_result",
            content="line1\nline2\nline3\nline4\nline5\nline6",
    ...
    def test_formats_read_result(self):
        """format_tool_result should show Read line count."""
        console = make_console()
        msg = AgentMessage(
            role="tool_result",
            content="def main():\n    pass\n",
